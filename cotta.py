"""
This code has been adopted from https://github.com/qinenergy/cotta.
"""
...
import base_model_cotta
import my_transforms

DEVICE = base_model_cotta.DEVICE
...
class CoTTA(nn.Module):
    ...
    def forward_and_adapt(self, x, model, optimizer):
        ...
        outputs_emas = []
        for i in range(N):
           # print(x.shape, self.transform(x).shape)
